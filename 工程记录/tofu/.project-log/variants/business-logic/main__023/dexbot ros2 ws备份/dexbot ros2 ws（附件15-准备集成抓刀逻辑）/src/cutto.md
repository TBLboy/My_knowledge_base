...
- **Phase1**: System waits for external knife-grab signal
...
- **Phase4**: Return to anchor, move to neutral pose, wait for user to rotate tofu, re-prepare
- **Phase5**: Second oblique cut — same cutting script as Phase3, independent config parameters
- **Phase6**: Return to anchor, wait for second user rotation, re-prepare with vertical knife (phase6_prepare config)
