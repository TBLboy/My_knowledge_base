...
- Files changed:
  ...
  - `.project-log/progress.md`
- Next steps:
  1. `source /home/tbl/Project/tofu/dexbot_ros2_ws/install/setup.bash`.
...
- Work completed:
  ...
  - Explored full dexbot_ros2_ws perception pipeline:
    ...
    - calibration_result.yaml: T_base_cam transformation exists at /home/tbl/Project/tofu/dexbot_ros2_ws/src/config/
...
- Work completed:
  - User copied calibration_result.yaml from desktop workspace: `/home/tbl/桌面/dexbot_ros2_ws/src/config/calibration_result.yaml` → `/home/tbl/Project/tofu/dexbot_ros2_ws/src/config/`
...
- Verification:
  - pose_estimator_node launched with params: depth_topic=/camera/camera/depth/image_rect_raw, camera_info_topic=/camera/camera/color/camera_info, calibration_file=/home/tbl/Project/tofu/dexbot_ros2_ws/src/config/calibration_result.yaml
...
- Files changed:
  - `/home/tbl/Project/tofu/dexbot_ros2_ws/src/config/calibration_result.yaml` (copied from desktop workspace)
...
ros2 launch dexbot_bringup calibration_manual_withUI.launch.py \
  ...
  auto_start:=false \
  marker_length:=0.038 \
  output_file:=/home/tbl/Project/tofu/dexbot_ros2_ws/src/config/calibration_result_new.yaml
```
...
ros2 launch cuttofo_xcore cuttofu_phase2.launch.py --show-args \
  ...
  # default: /home/tbl/Project/tofu/dexbot_ros2_ws/src/config/calib_right/calibration_result_right.yaml
```
