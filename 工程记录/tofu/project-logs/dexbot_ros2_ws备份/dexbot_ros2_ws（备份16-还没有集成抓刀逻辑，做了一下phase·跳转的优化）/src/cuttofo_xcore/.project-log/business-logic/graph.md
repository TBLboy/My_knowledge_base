...
| PHASE_4 | PHASE_2 (re-entry) | `/phase_jump` → `skip_return_motion=True` → continue file detected | `phase4_jump_continue` | Jump |
...
| PHASE_6 | PHASE_2 (re-entry) | `/phase_jump` → `skip_return_motion=True` → continue file detected | `phase6_jump_continue` | Jump |
